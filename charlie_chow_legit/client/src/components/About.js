...
class About extends Component {
  render() {
    return (
      <Header as='h1' textAlign='center'>Charlie Chow's Dragon Grill has always been known for it's fine Asian cuisine served in an attractive, contemporary setting in the heart of downtown Salt Lake City. 
      ...
      Plus, our traditon of friendly service and great food have made Charlie Chow's Dragon Grill a long time Salt Lake favorite.</Header>
    );

    <p>Charlie Chow, a Chinese-American immigrant, was born in China in the year 1874. 
    ...
    After three years in the Triad Center, the restaurant moved to Trolley Square, where it remained until 1999, and then moved to it's current location, 255 East 400 South, across from Salt Lake City's brand new city library project.</p>
  }
}
